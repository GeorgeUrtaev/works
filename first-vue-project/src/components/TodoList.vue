<!-- <template>
  <div  class="head">
    <input
      ...
      :value = 'newTodo'
    >
    <button @click="$emit('addTodo')">{{addTodoBtn}}</button>
    <button @click="$emit('complAndMove')" class="btn-compl-move">{{btnComplMove}}</button>
  </div>
  ...
  <ul class="list">
    ...
    >
      ...
      <div class="btns">
        <button @click="$emit('complet',todo)" class="btn-compl">{{btnCompl}}</button>
        <button @click="$emit('redactEl',todo)" class="btn-redact">
          {{btnRedact}}
        </button>
        <button @click="$emit('deleteEl',index)" class="btn">{{btnDel}}</button>
      </div>
    </li>
  </ul>
  <ul class="list">
...
<!-- <script>
  export default{
    ...
    methods:
    {
      ...
      redactEl(el)
      {
        el.name = this.newTodo
        this.newTodo = ''
      },
      complAndMove()
      {
        this.completedTodoList = this.todoList.filter((el)=>
        {
